...
<div class="container">
    ...
    <div class="card card-container">
        ...
        <form action="${loginUrl}" method="post" class="form-signin">
            ...
            <button class="btn btn-lg btn-primary btn-block btn-signin" type="submit" a href="${pageContext.request.contextPath }/allBooks">Sign in
            </button>
        </form>
        ...
        <div class="margin-bottom-10">
            Don't have account? <a href="${pageContext.request.contextPath }/registration" class="register">Create account</a>
        </div>
    </div>
</div>
